...
insert into perm_server_group (server_id, id1, id2, perm_id, perm_value, perm_negated, perm_skip) values (0, 1, 0, "b_channel_create_permanent", 0, 1, 1);
insert into perm_server_group (server_id, id1, id2, perm_id, perm_value, perm_negated, perm_skip) values (0, 1, 0, "b_channel_create_semi_permanent", 0, 1, 1);
insert into perm_server_group (server_id, id1, id2, perm_id, perm_value, perm_negated, perm_skip) values (0, 1, 0, "b_channel_create_temporary", 0, 1, 1);
insert into perm_server_group (server_id, id1, id2, perm_id, perm_value, perm_negated, perm_skip) values (0, 1, 0, "b_channel_join_permanent", 0, 1, 1);
insert into perm_server_group (server_id, id1, id2, perm_id, perm_value, perm_negated, perm_skip) values (0, 1, 0, "b_channel_join_semi_permanent", 0, 1, 1);
insert into perm_server_group (server_id, id1, id2, perm_id, perm_value, perm_negated, perm_skip) values (0, 1, 0, "b_channel_join_temporary", 0, 1, 1);
...
insert into perm_server_group (server_id, id1, id2, perm_id, perm_value, perm_negated, perm_skip) values (0, 1, 0, "i_client_private_textmessage_power", -1, 1, 1);
insert into perm_server_group (server_id, id1, id2, perm_id, perm_value, perm_negated, perm_skip) values (0, 1, 0, "b_client_server_textmessage_send", 0, 1, 1);
insert into perm_server_group (server_id, id1, id2, perm_id, perm_value, perm_negated, perm_skip) values (0, 1, 0, "b_client_channel_textmessage_send", 0, 1, 1);
insert into perm_server_group (server_id, id1, id2, perm_id, perm_value, perm_negated, perm_skip) values (0, 1, 0, "b_client_offline_textmessage_send", 0, 1, 1);
insert into perm_server_group (server_id, id1, id2, perm_id, perm_value, perm_negated, perm_skip) values (0, 1, 0, "i_client_poke_power", -1, 1, 1);
