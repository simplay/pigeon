...
+ Java 7
+ The Bundler gem
+ A Teamspeak 3 server with query admin access. Please note that the following permissions have to be set like specified below in order to let the bot run properly:
